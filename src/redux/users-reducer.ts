...
export const requestUsers =
  (page: number, pageSize: number, filter: FilterType): ThunkType<ActionTypes> =>
  async (dispatch) => {
...
export const actionsUsers = {
  ...
  isFollowingProgress: (isDisabling: boolean, userID: number) =>
    ({ type: 'IS_FOLLOWING', isDisabling, userID } as const),
